...
text_tbl <- data.frame(
  FM = c("VAR", "fevd", "irf", "predict", "summary", "arch.test_sh",
         "normality.test_sh", "serial.test_sh", "stability_sh"),
  ...
  FC = c(paste0("Acoef_sh, arch.test_sh, Bcoef_sh, BQ_sh, causality_sh, ",
                "normality.test_sh, restrict_sh, roots_sh, serial.test_sh, ",
                "stability_sh"),
         " ", " ", "fanchart", " ", " ", " ", " ", " ")
)
...
knitr::kable(round(resu_sse, 3),
             caption = paste0("Table 2. Sum of squared errors of VAR ",
                              "coefficients estimated by the shrinkage ",
                              "methods."))
```
