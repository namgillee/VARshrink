...
for (idT in 1:length(NumTimePTS)) {
  ...
  for (r in 1:50) {
    ...
    resu_SSE[r, 1, idT] <- calcSSE_Acoef(Acoef.varshrinkest(EstimRG), Ad$A)
    resu_SSE[r, 2, idT] <- calcSSE_Acoef(Acoef.varshrinkest(EstimNS), Ad$A)
    resu_SSE[r, 3, idT] <- calcSSE_Acoef(Acoef.varshrinkest(EstimFB), Ad$A)
    resu_SSE[r, 4, idT] <- calcSSE_Acoef(Acoef.varshrinkest(EstimSB), Ad$A)
  }
}
```
