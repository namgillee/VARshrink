...
----------------------|---------------|---------------------|---------------------|
| VAR                 | varshrinkest, | coef, fevd, fitted, |   Acoef_sh,         |
|                     | varest        |  irf, logLik, Phi,  |    arch.test_sh,    |
|                     |               |  plot, predict, print,|  Bcoef_sh,        |
|                     |               |   Psi, resid, summary|    BQ_sh,          |
|                     |               |                     |  causality_sh,      |
|                     |               |                     |   normality.test_sh,|
|                     |               |                     | restrict_sh,|
|                     |               |                     | roots_sh,|
...
| irf                 | varshirf,     | plot, print         |             |
|                     | varirf        |                     |             |
| predict             | varprd        | plot, print         |  fanchart             |
| summary             | varshsum,     | print               |             |
|                     | varsum        |                     |             |
...
Table:\label{tab:methods}Structure of the package VARshrink.
